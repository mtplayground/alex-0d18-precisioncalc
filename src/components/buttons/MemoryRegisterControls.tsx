...
export function MemoryRegisterControls({
  ...
  return (
    <section
      ...
      className="grid gap-3 rounded-md border border-amber-300/25 bg-amber-300/5 p-2"
    >
      <div className="flex items-center justify-between gap-3">
        <span className="text-[0.68rem] font-semibold uppercase tracking-[0.16em] text-zinc-500">
          Register
        </span>
        <span className="rounded border border-amber-300/30 bg-zinc-950/80 px-2 py-1 font-mono text-xs font-semibold text-amber-100">
          {storedValue}
        </span>
      </div>
